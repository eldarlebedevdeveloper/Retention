...
function cases() {
    ...
    casesSize()
      ...
      function casesSize() {
            ...
            const headerHight = document.querySelector('.cases_left-header').offsetHeight
            const navigationHeight = document.querySelector('.cases_left-navigation').offsetHeight
          ...
          if(mediaQuery1024){
                // document.querySelector('.cases_left-header').style.height = hight * .55 + 'px'

                document.querySelector('.cases_logoSlider').style.height = hight * .3 + 'px'

                document.querySelectorAll('.cases_realization').forEach(block => {
                    block.style.height = hight * .8 + 'px'
                ...
                document.querySelectorAll('.cases_slide-picture').forEach(block => {
                    block.style.height  =  hight * .55 + 'px'
                })
      
                document.querySelector('.cases_slide-background').style.height = hight * .55 + 'px'

                if(mediaQuery768){
                  document.querySelector('.cases_logoSlider').style.height = hight * .75 + 'px'
                 
                  document.querySelectorAll('.cases_slide-picture').forEach(block => {
                      block.style.height  =  hight * .75 + 'px'
                  })
                
                  document.querySelector('.cases_slide-background').style.height = hight * .75 + 'px'


                  mobileNavigation() 

                  function mobileNavigation() {
                      const buttonRealization = document.querySelector('.cases_mobile_navigation-realization')
                      const buttonResult = document.querySelector('.cases_mobile_navigation-result')

                      const realizationItems = document.querySelectorAll('.cases_realization')
                ...
                document.querySelector('.cases_logoSlider').style.height = navigationHeight * 1 + 'px'
                ...
                document.querySelector('.cases_slide-background').style.height =( navigationHeight * 1) + 3.5 + 'px'
          }
...
// ===================================================
  ...
  function  casesSlider() {
      ...
      frontPage.src = 'https://ston.ch/wp-content/themes/photographerTHEME/js/deleteretention.js'
      ...
      function casesActivateSliders() {
              ...
              // curentProgresSLider.controller.control = logoSwiperCases
              // logoSwiperCases.controller.control = swiperCases
              ...
              function backgroundAnimation() {
                  let backgroundImages = document.querySelectorAll('.cases_slide-background img')
                  ...
                  backgroundImages[cassesSlideIndex].classList.add('cases_background_active')
              }
              ...
              document.querySelector('.cases_navigation .slider_navigation-next').addEventListener(eventClick, () => {
                cassecButtonProgressline(true)  
              })
              document.querySelector('.cases_navigation .slider_navigation-prev').addEventListener(eventClick, () => {
              ...
              function casesButtonNext(mainPercent) {
                  ...
                  if(mediaQuery1024){
                      ...
                      if(mediaQuery768){
                        ...
                        document.querySelector('.cases_navigation .slider_navigation-next img').src = 'img/arrow_slider.svg'
