...
function retentionSlider() {
    ...
    const notificationItems = document.querySelectorAll('.retention_notifications-item')
    ...
    // const mobileNotificationHide = (notificationItems[1].querySelector('img.mob').clientHeight + 10) * -1 + 'px'
    ...
    function automaticScrollButtonsOnTheMobileVersion(){
      ...
      var emailRet = document.querySelector(".retention_buttons [data-retentioButton='0']")
      var callRet = document.querySelector(".retention_buttons [data-retentioButton='2']")
      var automatizationRet = document.querySelector(".retention_buttons [data-retentioButton='4']")
      var pushRet = document.querySelector(".retention_buttons [data-retentioButton='6']")
      ...
      callRet.addEventListener('click', ()=> {
          if(containerRet.scrollLeft < emailRet.offsetLeft + emailRet.clientWidth){
      ...
      automatizationRet.addEventListener('click', ()=> {
          ...
          // console.log(pushWidth)
          // console.log(automatizationRet.offsetLeft)
          // console.log(scrollAutomatizationStop)
    ...
    function slideShow(numberSlide) {
      ...
      retentionSlides[numberSlide].querySelector(`img.ret_desc`).classList.remove('ret_desc_animation')
  ...
  function scrollNotification(){
    ...
    if(iOS != null){
      ...
      document.querySelectorAll('.retention_notifications-item img.mob').forEach(picture => {
    ...
    function stopMessageMelody(){
        ...
        document.querySelector('.retention_images-slider').style.height =  document.querySelector('.retention_images').clientHeight + 'px'
        ...
        // retentionImage.controller.control = retentionText
        // retentionText.controller.control = retentionImage
...
// ===================================================
        ...
        document.querySelector('.retention_navigation .slider_navigation-next').addEventListener(eventClick, () => {
          retentionButtonsActive(retentionText.realIndex)
                     

        })
        document.querySelector('.retention_navigation .slider_navigation-prev').addEventListener(eventClick, () => {
          retentionButtonsActive(retentionText.realIndex)
        })
  ...
  // ===================================================
        ...
        function retentionButtonsActive(index){
            ...
            const numberActiveSlide = Number(document.querySelector('.retention_button-active').dataset.retentiobutton) + 1
          ...
          function notificationChangeSlide(index) {
               ...
               stopMessageMelody()
                ...
                notification.addEventListener(eventClick, () => {
                    // notification.style.right = notificationHiddenRight
                    // if(index == 1){
                    //     notificationItems[index].classList.add('none_message')
                    // }
                    notificationContainerHide()
                    slideShow(index)
                })
