...
<head>
    ...
    <!-- <link rel="prefetch prerender" href="img/preloader/flask_anton222.gif" /> -->
    <link rel="preload" as="image" href="/img/preloader/flask_anton222.gif">
    <link rel="stylesheet" href="css/preLoader.css">
    <!-- <link rel="stylesheet" href="css/preLoaderSecondVirsion.css"> -->
...
<!-- <div class="gif_preloader ">
        <div class="gif_preloader_gif_container none ">
            <img loading="lazy" loading="lazy"  class="gif_preloader_gif"  src="preloader/flask_anton222-min.gif" alt=""  />
        </div>
    </div> -->
...
<div class='wraper y-hidden'>
    ...
    <section class="retention">
        ...
        <div class="retention_buttons">
            <div class="retention_button retention_button-active" data-retentioButton='0' onclick="" ><h4>Email</h4></div>
            <div class="retention_button " data-retentioButton='1' onclick="ipnoneMelody()" ><h4>мессенджеры</h4></div>

            <div class="retention_button" data-retentioButton='2' onclick="ipnoneMelody()" ><h4>обзвоны</h4></div>
            <div class="retention_button" data-retentioButton='3' onclick="ipnoneMelody()" ><h4>sms</h4></div>
            <div class="retention_button" data-retentioButton='4' onclick="ipnoneMelody()" ><h4>автоматизация процессов</h4></div>
            <div class="retention_button" data-retentioButton='5' onclick="ipnoneMelody()" ><h4>VIP</h4></div>
            <div class="retention_button" data-retentioButton='6' onclick="ipnoneMelody()" ><h4>push</h4></div>
        </div>
        ...
        <script>
                ...
                function ipnoneMelody() {
                    var audioIphone = new Audio(); // Создаём новый элемент Audio
                    audioIphone.src = 'sound/iphone.mp3'; // Указываем путь к звуку "клика"

                    audioIphone.volume = 0
                    audioIphone.muted = true
            console.log(audioIphone)

                    audioIphone.autoplay = true; // Автоматически запускаем
                }
                ...
                <div class=" swiper-wrapper">
                    <div class="retention_text swiper-slide">
                        ...
                        <div class="retention_text-description">
                            <p>Обзвоны клиентской базы достаточно важный элемент работы Retention направления который безусловно увеличивает конечный результат.
                                Особенно важно, фиксировать customer lifecycle и постоянно поддерживать его в актуальном состоянии.
                                За время работы, мы выявили тенденцию, что определенная часть клиентов поддерживает общение с продуктом исключительно по телефону. Более того, часть из них возвращается только после повторных звонков.
                                </p>
                        </div>
                    </div>
                    <div class="retention_text swiper-slide">
        ...
        <div class="cases_slider swiper">
            <div class=" swiper-wrapper">
                ...
                <div class="cases_slider-slide swiper-slide" id="cases_monkey">
                    <div class="cases_realization cases_slide-text" >
                        <h4>Реализация</h4>
                        <p>Составили полную программу по каналам коммуникации для ретеншна пользователей и адаптировали сайт 
                            под разные гео по предпочтениям игроков. Внедрили новые акции и соревнования под игроков, 
                            ставящих на лайв и слоты. Разработали программу по обработке сегмента VIP и план по получению
                ...
                <div class="cases_slider-slide swiper-slide" id="cases_betmatch" >
                    <div class="cases_realization cases_slide-text" >
                        <h4>Реализация</h4>
                        <p>Реализация Retention направления и оперирование продуктом под ключ. Была разработана мультиязычная 
                            автоматизированная цепочка email-писем с учетом разных сценариев customer lifecycle. Параллельно 
                            запустили работу через мессенджеры в полу автоматическом режиме. Особое внимание было уделено 
                    ...
                    <div class="cases_result cases_slide-text" >
                        <h4>Результат</h4>
                        <p>Анализируя конкретно retention деятельность, ежемесячный conversion rate держался в промежутке 30-40%.
                            Геометрический скачек пользовательской активности произошел в период с января по май 2020 г. 
...
?>
    ...
    <section class="contact">
        ...
        <div class="contact_form">
            ...
            <script>
                $(".contact_form-form").submit(function (e) { // Устанавливаем событие отправки для формы с id=form
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        // headers: {"Authorization": localStorage.getItem('09ba5ebedb45c5590f21c716364f8318')}
                    });
                });

                // $(".popUp_form").submit(function (e) { // Устанавливаем событие отправки для формы с id=form
                //    e.preventDefault();
        ...
        <div class="contact_information-contacts">
            ...
            <div class="information">
                <a href="https://t.me/eeniemo" target="_blank">
                    ...
                    <!-- <p class="information_link"><a href="https://t.me/eeniemo" target="_blank">t.me/Gainlab →</a></p> -->
                    <p class="information_link"><a href="https://t.me/eeniemo" target="_blank">t.me/eeniemo →</a></p>
                </a>
        </div>
        </div>
    </section>
    ...
    <script>
        ...
        // setTimeout(() => {
        //     document.querySelector('.preloader_container').classList.remove('none')
        // }, 500);
        
        // loadImage()
        // function loadImage() {

        //     var src = 'https://gainlab.tech/img/preloader/load_background2.png'; // ссылка для картинки
        //     var img = document.createElement("img"); // создаем абстрактное изображение

        //     /* функция выполнится после загрузки картинки */
        //     img.onload = function() {
                // document.querySelector('.loader-bg').style.backgroundImage = "url(" + src + ")"; // устанавливаем картинку как фон
        //         document.querySelector('.preloader_container').classList.remove('none')
        ...
        // document.querySelector('.loader-bg').onload(() => {
        //     document.querySelector('.preloader_container').classList.remove('none')     
        // })
        ...
        //         console.log(allImagesWebSite[i])
        //     }
        ...
        // var img = document.querySelector('.gif_preloader_gif')
